...
import { Plus, ShoppingCart, Ban, RotateCcw, ChevronDown, ChevronUp } from 'lucide-react'
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Registra y administra tus compras en cuotas
          </p>
        </div>
        <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
          ...
          <DialogContent className="max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Registra una nueva compra con cuotas
              </DialogDescription>
            </DialogHeader>
            <div className="grid gap-4 py-4">
              ...
              {formData.totalAmount > 0 && formData.installments > 0 && (
            ...
            <DialogFooter>
              ...
              <Button
                ...
                disabled={createMutation.isPending || !formData.cardId || !formData.description || formData.totalAmount <= 0}
              >
      ...
      {!cards?.length ? (
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <h3 className="text-lg font-medium mb-2">Primero agrega una tarjeta</h3>
            <p className="text-muted-foreground text-center mb-4">
              Necesitas tener al menos una tarjeta para registrar gastos
            </p>
            <Button asChild>
              <a href="/dashboard/cards">Ir a Tarjetas</a>
            </Button>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-muted-foreground text-center mb-4">
              Registra tu primer gasto para comenzar a trackear tus cuotas
            </p>
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-sm text-muted-foreground">
                      {transaction.installments} cuota{transaction.installments > 1 ? 's' : ''} de{' '}
